...
<body data-spy="scroll" data-target=".mainmenu-area">
            ...
            <div class="row">
               <div class="hidden-xs col-sm-6 col-lg-6">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 col-lg-offset-1">
                    ...
                    <h3 class="page-title wow fadeInUp" data-wow-delay="0.5s">Job Opportunity</h3>
            ...
            <div class="row">
               <div class="hidden-xs col-sm-6 col-lg-6">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 col-lg-offset-1">
                    ...
                    <h3 class="page-title wow fadeInUp" data-wow-delay="0.5s">Regular Mock tests and exams</h3>
    ...
    <section id="faq" class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h3 class="page-title">Mentrow features</h3>
                    <div class="space-60"></div>
                </div>
            </div>
            <div class="row">
                ...
                @csrf
                        <div class="form-double">
                            <div class="form_group">
                                <input id="name" name="name" placeholder="Name" class="form_control" required="required">
                            </div>
                            <div class="form_group last">
                                <input type="email" id="email" name="email" placeholder="Email" required="required" class="form_control">
                            </div>
                        </div>
